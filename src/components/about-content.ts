...
export const ISSIEVOICE_ABOUT: Record<string, string[]> = {
  en: [
    ...
    'Users can save frequently used sentences for quick access, and mark their most important ones as favorites for even faster communication.',
    'Developed by Beit Issie Shapiro Technology Center in collaboration with SAP Labs Israel.',
  ],
  he: [
    ...
    'המשתמשים יכולים לשמור משפטים נפוצים לגישה מהירה, ולסמן את החשובים ביותר כמועדפים לתקשורת מהירה עוד יותר.',
    'פותחה על ידי מרכז הטכנולוגיה של בית איזי שפירא בשיתוף פעולה עם SAP Labs Israel.',
  ],
  ar: [
    ...
    'يمكن للمستخدمين حفظ الجمل المستخدمة بشكل متكرر للوصول السريع، وتمييز الأهم منها كمفضلة للتواصل بشكل أسرع.',
    'تم تطويره بواسطة مركز التكنولوجيا في بيت إيزي شابيرو بالتعاون مع SAP Labs Israel.',
  ],
};
